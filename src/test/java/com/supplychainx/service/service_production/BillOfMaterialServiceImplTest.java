...
class BillOfMaterialServiceImplTest {
    ...
    @Mock private BillOfMaterialMapper billOfMaterialMapper;
    @Mock private ProductRepository productRepository;
    @Mock private MatierePremiereRepository matierePremiereRepository;

    @InjectMocks private BillOfMaterialServiceImpl billOfMaterialService;

    @Test void createBillOfMaterial_ShouldReturnResponseDTO() {
        BillOfMaterialRequestDTO request = new BillOfMaterialRequestDTO();
        BillOfMaterial bom = new BillOfMaterial();
        BillOfMaterialResponseDTO response = new BillOfMaterialResponseDTO(1L, null, null, null, 0.0, null, null);
    ...
    @Test void getBillOfMaterialById_ShouldReturnResponseDTO_WhenExists() {
        BillOfMaterial bom = new BillOfMaterial();
        BillOfMaterialResponseDTO response = new BillOfMaterialResponseDTO(1L, null, null, null, 0.0, null, null);
    ...
    @Test void updateBillOfMaterial_ShouldReturnUpdatedDTO_WithProductAndMatiere() {
        BillOfMaterialRequestDTO request = new BillOfMaterialRequestDTO(1L, 1L, 0.0);
    ...
    @Test void deleteBillOfMaterial_ShouldDelete_WhenExists() {
        BillOfMaterial bom = new BillOfMaterial();
        when(billOfMaterialRepository.findById(1L)).thenReturn(Optional.of(bom));
    ...
    @Test void getAllBillOfMaterials_ShouldReturnPage() {
